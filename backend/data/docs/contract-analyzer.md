...
> [!INFO] Why it exists
> Legal review queues were the slowest step in supplier onboarding. This turns a 40-page contract into a one-page summary and clause table so lawyers review exceptions, not everything.
