...
> [!INFO] Why it exists
> Disputes were missing scheme deadlines because triage was manual. This classifies, checks the rules and drafts the case so analysts only handle the ambiguous ones.
